<template>
    <div class="h-screen w-screen bg-neutral-900 bg-opacity-0 fixed top-0 left-0 z-[90] flex items-center justify-center">
...
<script setup>
    ...
    async function update() {
        try {
            ...
            // Update Data
            await SettingsStore.update(id.value, updatedItem);
        ...
        if (Object.keys(SettingsStore.errors).length > 0) {
            ...
            // Alert
            emit('showAlert', 'App details has been updated.');
        }
